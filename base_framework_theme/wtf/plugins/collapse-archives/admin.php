<?php
add_action('admin_menu', 'wpsm_collapse_arch_admin');

function wpsm_collapse_arch_admin()
{
    $collapse_arch_page = add_submenu_page('theme-plugins', 'Collapsing Archives', 'Collapsing Archives', 'manage_options', 'theme-plugins-collapse-arch', 'wpsm_collapse_arch_plugin_page');
    add_action('admin_head-' . $collapse_arch_page, 'wpsm_header');
} //end wpsm_twitter_admin

function wpsm_collapse_arch_plugin_page()
{
    check_admin_referer();
...
<div style="clear:both;height:20px;"></div>
    <?php
} //end wpsm_collapse_arch_plugin_page
