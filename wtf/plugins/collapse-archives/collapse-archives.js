$(document).ready(function() {
    ...
    $('.collapse-archives-list li').each(function(){
        var li = $(this);
        if (li.parent().hasClass('post-list')) {
            return;
        }
        var id = $(this).attr('id');
        li.addClass('closed').prepend('<a href="#" id="' + id + '-toggle" class="collapse-archives-toggle">[+]</a>');
    });
    
    $('.collapse-archives-toggle').click(function(){
        var link   = $(this);
        ...
        if (parent.hasClass('closed')) {
            $('#' + parentId + ' > .collapse-archives-toggle').html('[-]');
        } else {
            $('#' + parentId + ' > .collapse-archives-toggle').html('[+]');
        }
        $('#' + parentId).toggleClass('closed').toggleClass('open');
    });
});
